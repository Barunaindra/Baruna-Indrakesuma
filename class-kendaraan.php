...
<?php
class pesawat extends kendaraan  //soal no 1
{
	private $tinggiMaks;       //soal no 2
	private $KecepatanMaks;


	function setTinggiMaks ($x)  // soal no 3
	{
		$this->TinggiMaks=$x;
	}
	...
	function bacaTinggiMaks ()  // soal no 4
	{
	...
	function biayaOperasional() // soal no 5
	{
...
$pesawat1 = new pesawat () ;              // soal no 6
